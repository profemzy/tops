...
from titansops.extensions import db
from titansops.extensions import debug_toolbar
from titansops.extensions import flask_static_digest
from titansops.page.views import page
from titansops.up.views import up
